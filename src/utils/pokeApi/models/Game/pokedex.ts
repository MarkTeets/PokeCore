 ...
 * one which is capable of recording and retaining information of the various Pokémon in a given
 * region with the exception of the national dex and some smaller dexes related to portions of a
 * region.
