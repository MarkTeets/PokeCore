 ...
 * A Pokémon's Characteristic is determined by the remainder of its highest IV divided by 5
 * (gene_modulo).
 * - Check out [Bulbapedia](https://bulbapedia.bulbagarden.net/wiki/Characteristic) for details
 */
