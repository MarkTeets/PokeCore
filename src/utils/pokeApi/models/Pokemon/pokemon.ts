 ...
 * which makes it differ from other Pokémon of the same species, such as base stats, available
 * abilities and typings.
 * - See [Bulbapedia](https://bulbapedia.bulbagarden.net/wiki/Pok%C3%A9mon_(species)) for greater
 * detail.
 */
export type Pokemon = {
 ...
 * The color listed in the Pokédex is usually the color most apparent or covering each Pokémon's
 * body.
 ...
 * which do differ in more than just visuals, the 'Pokémon' entity is used to represent such a
 * variety.
 */
export type PokemonForm = {
  ...
  version_group: NamedAPIResource;
  /** The form specific full name of this Pokémon form, or empty if the form does not have a
   * specific name */
  names: Name[];
  /** The form specific form name of this Pokémon form, or empty if the form does not have a
   * specific name */
  form_names: Name[];
  /** A list of details showing types this Pokémon has */
  types: PokemonType[];
...
export type PalParkEncounterArea = {
  /** The base score given to the player when the referenced Pokémon is caught during a pal park
   * run */
  base_score: number;
