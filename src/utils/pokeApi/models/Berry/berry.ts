...
export type Berry = {
  ...
  name: string;
  /** Time it takes the tree to grow one stage, in hours. Berry trees go through four of these
...
/**
 * Reference to the flavor a berry can have and the potency of each of those flavors in regard to
 * this berry
 */
 ...
 *
 * - Check out [Bulbapedia](https://bulbapedia.bulbagarden.net/wiki/Category:Berries_by_firmness)
 * for greater detail
 */
