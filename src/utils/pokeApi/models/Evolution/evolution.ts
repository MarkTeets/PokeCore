...
export type EvolutionDetail = {
  ...
  /** The move that must be known by the evolving Pokémon species during the evolution trigger
   * event in order to evolve into this Pokémon species. */
  known_move: NamedAPIResource | null;
  /** The evolving Pokémon species must know a move with this type during the evolution trigger
   * event in order to evolve into this Pokémon species. */
  known_move_type: NamedAPIResource | null;
  /** The location the evolution must be triggered at. */
  location: NamedAPIResource | null;
  /** The minimum required level of the evolving Pokémon species to evolve into this Pokémon
   * species. */
  ...
  /** The Pokémon species that must be in the players party in order for the evolving Pokémon
...
export type ChainLink = {
  /** Whether or not this link is for a baby Pokémon. This would only ever be true on the base
   * link */
  is_baby: boolean;
 ...
 * such as being traded, achieving a certain amount of friendship or leveling at certain times,
 * among others.
 * - Check out [Bulbapedia](https://bulbapedia.bulbagarden.net/wiki/Methods_of_evolution) for
 * greater detail.
 */
